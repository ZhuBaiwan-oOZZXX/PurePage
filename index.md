...
#### API 代理
  - [Anannas API 代理](#note/API%20代理/Anannas%20API%20代理.md) 2026-02-04
  - [小马算力 API 代理](#note/API%20代理/小马算力%20API%20代理.md) 2026-02-04
  - [心流 iflow API 代理](#note/API%20代理/心流%20iflow%20API%20代理.md) 2026-02-04
  ...
  - [美团 LongCat API代理](#note/API%20代理/美团%20LongCat%20API代理.md) 2026-02-04
...
#### dev
  ...
  - [TG 获取 Channel ID 与 TG_BOT_TOKEN](#note/dev/TG%20获取%20Channel%20ID%20与%20TG_BOT_TOKEN.md) 2026-02-04
  - [VSCode文件空包折叠展开](#note/dev/VSCode文件空包折叠展开.md) 2026-02-04
  - [Windows 上禁用 CapsLock 键](#note/dev/Windows%20上禁用%20CapsLock%20键.md) 2026-02-04
  - [Windows 设置命令别名（alias）](#note/dev/Windows%20设置命令别名（alias）.md) 2026-02-04
  - [修复 Windows 数字显示成符号的异常](#note/dev/修复%20Windows%20数字显示成符号的异常.md) 2026-02-04
  - [国内服务器安装 uv](#note/dev/国内服务器安装%20uv.md) 2026-02-04
  - [常用 git 命令](#note/dev/常用%20git%20命令.md) 2026-02-04
...
- [我的第一篇笔记](#测试/我的第一篇笔记.md) 2026-02-04
- [测试教程](#测试/测试教程.md) 2026-02-04
